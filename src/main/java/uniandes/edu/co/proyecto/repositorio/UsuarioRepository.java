...
/*
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO USUARIO (TIPO_DOCUMENTO, NUMERO_DOCUMENTO, NOMBRE, NACIONALIDAD, DIRECCION_FISICA, DIRECCION_DIGITAL, TELEFONO, CODIGO_POSTAL, TIPO_USUARIO,ID_DATOS_USUARIO) VALUES (:tipo_documento, :numero_documento, :nombre, :nacionalidad, :direccion_fisica, :direccion_digital, :telefono, :codigo_postal, :tipo_usuario,:id_datos_usuario)", nativeQuery = true)
    void insertarUsuario(@Param("tipo_documento") String tipo_documento, @Param("numero_documento") Integer numero_documento,@Param("nombre") String nombre,  @Param("nacionalidad") Integer nacionalidad, @Param("direccion_fisica") String direccion_fisica, @Param("direccion_digital") String direccion_digital, @Param("telefono") Integer telefono, @Param("codigo_postal") Integer codigo_postal, @Param("tipo_usuario") String tipo_usuario,@Param("id_datos_usuario") Integer id_datos_usuario);
